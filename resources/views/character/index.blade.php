...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="{{asset('assets/img/navbar-logo.png')}}" height="50" alt="GetGood" /></a>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="portfolio-item">
                                <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal{{ $ev->id }}">
                                    ...
                                    <img class="img-fluid" src="{{ asset($ev->file) }}"  alt="Event" />
                                </a>
                                <div class="portfolio-caption">
                                    <div class="portfolio-caption-heading">{{ $ev->event_type }}</div>
                                </div>
                            </div>
                        </div>
                    @endforeach
  ...
  <!-- Portfolio Modals-->
        ...
        @foreach ($e as $ev)
            <div class="portfolio-modal modal fade" id="portfolioModal{{ $ev->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="modal-body text-center">
                                        <!-- Project details-->
                                        <h2 class="text-uppercase">{{ $ev->event_type }}</h2>
                                        <img class="img-fluid d-block mx-auto" src="{{ asset($ev->file) }}" alt="Event" />
                                        <p class="item-intro text-muted">{{ $ev->description }}</p>
